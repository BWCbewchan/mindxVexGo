(window["webpackJsonpwebapp"] = window["webpackJsonpwebapp"] || []).push([[30],{

/***/ "./src/HardwareInterface/IQEXPV5/IQ/IQWebSerial.ts":
/*!*********************************************************!*\
  !*** ./src/HardwareInterface/IQEXPV5/IQ/IQWebSerial.ts ***!
  \*********************************************************/
/*! exports provided: IQWebSerial */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IQWebSerial", function() { return IQWebSerial; });
...
/* harmony import */ var _rm_vca_vexcode_webserial__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @rm-vca/vexcode-webserial */ "./node_modules/@rm-vca/vexcode-webserial/dist/index.js");
...
/* harmony import */ var _rm_vca_vexcode_webserial_dist_errors__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @rm-vca/vexcode-webserial/dist/errors */ "./node_modules/@rm-vca/vexcode-webserial/dist/errors.js");
...
var log = _rm_vca_logger__WEBPACK_IMPORTED_MODULE_0__["getLogger"]("IQWebSerial");
...
var IQWebSerial = /*#__PURE__*/function (_IQInterface) {
  _inherits(IQWebSerial, _IQInterface);
  var _super = _createSuper(IQWebSerial);
  // tslint:disable-next-line: variable-name

  function IQWebSerial() {
    var _this;
    _classCallCheck(this, IQWebSerial);
    _this = _super.call(this);
    _defineProperty(_assertThisInitialized(_this), "_serial", new _rm_vca_vexcode_webserial__WEBPACK_IMPORTED_MODULE_4__["VexIQWebSerial"]());
    _defineProperty(_assertThisInitialized(_this), "lastSerialState", _rm_vca_vexcode_webserial__WEBPACK_IMPORTED_MODULE_4__["VexWebSerialConnectionStates"].Disconnected);
    ...
    _defineProperty(_assertThisInitialized(_this), "lastUserPortState", _rm_vca_vexcode_webserial__WEBPACK_IMPORTED_MODULE_4__["VexWebSerialConnectionStates"].Disconnected);
  ...
  _createClass(IQWebSerial, [{
    key: "onSerialStateChange",
    value: function onSerialStateChange(state) {
      log.debug("onSerialStateChange - new state:", _rm_vca_vexcode_webserial__WEBPACK_IMPORTED_MODULE_4__["VexWebSerialConnectionStates"][state]);
      if (this.lastSerialState === state) {
        return;
      }
      this.lastSerialState = state;
      var connectionState = this.getConnectionState();
      this.fireEvent("connectionStateChange", connectionState);
      _GlobalEventSystem__WEBPACK_IMPORTED_MODULE_6__["fireEvent"]("HWInterface.ConnectionStateChange", connectionState);
      if (state === _rm_vca_vexcode_webserial__WEBPACK_IMPORTED_MODULE_4__["VexWebSerialConnectionStates"].Connected) {
        this.onBrainConnected();
      } else if (state === _rm_vca_vexcode_webserial__WEBPACK_IMPORTED_MODULE_4__["VexWebSerialConnectionStates"].Disconnected) {
    ...
    value: function getConnectionState() {
      ...
      var isConnected = state === _rm_vca_vexcode_webserial__WEBPACK_IMPORTED_MODULE_4__["VexWebSerialConnectionStates"].Connected;
    ...
    value: function getBrainInfo() {
      ...
      var deviceType = isController ? _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["VexDeviceType"].VEXIQ2_Controller : isIQ2 ? _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["VexDeviceType"].VEXIQ2 : _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["VexDeviceType"].VEXIQ;
      var info = {
        ...
        needsFWUpdate: hasBrainVersion ? isIQ1 ? needsFWUpdateIQ1 : tmpInfo.updateNeededBrain ? _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["UpdateNeededOptions"].NeedsUpdate : _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["UpdateNeededOptions"].UpToDate : tmpInfo.isDFUMode ? _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["UpdateNeededOptions"].NeedsUpdate : _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["UpdateNeededOptions"].Unsure,
        ...
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            case 0:
              ...
              isCPP = language === "cpp";
              icon = isBlocks ? _rm_vca_vexcode_webserial__WEBPACK_IMPORTED_MODULE_4__["VEXcodeIcons"].VEXcodeBlocks : isCPP ? _rm_vca_vexcode_webserial__WEBPACK_IMPORTED_MODULE_4__["VEXcodeIcons"].VEXcodeCPP : _rm_vca_vexcode_webserial__WEBPACK_IMPORTED_MODULE_4__["VEXcodeIcons"].VEXcodePython;
          ...
          while (1) switch (_context9.prev = _context9.next) {
            ...
            case 2:
              ...
              progressHandler = function progressHandler(state, percent, msg) {
                log.debug("progressHandler:", percent, _rm_vca_vexcode_webserial__WEBPACK_IMPORTED_MODULE_4__["VEXBrainUpdateStates"][state], msg);
              ...
              _context9.next = 14;
              return Object(_helpers__WEBPACK_IMPORTED_MODULE_13__["waitms"])(5);
            case 14:
              _context9.next = 16;
            ...
            case 20:
              ...
              if (_context9.t0 instanceof _rm_vca_vexcode_webserial_dist_errors__WEBPACK_IMPORTED_MODULE_11__["WebSerialUnsupportedError"]) {
                msg1Key = "WebSerial Update Failed - webserial not supported";
              } else if (_context9.t0 instanceof _rm_vca_vexcode_webserial_dist_errors__WEBPACK_IMPORTED_MODULE_11__["NoBrainConnectedError"]) {
                msg1Key = "WebSerial Update Failed - no device";
              } else if (_context9.t0 instanceof _rm_vca_vexcode_webserial_dist_errors__WEBPACK_IMPORTED_MODULE_11__["OperationNotSupportedError"]) {
                msg1Key = "WebSerial Update Failed - not supported";
              } else if (_context9.t0 instanceof _rm_vca_vexcode_webserial_dist_errors__WEBPACK_IMPORTED_MODULE_11__["ErrorUpdatingBrainGolden"]) {
                msg1Key = "WebSerial Update Failed - recovery update failed";
              } else if (_context9.t0 instanceof _rm_vca_vexcode_webserial_dist_errors__WEBPACK_IMPORTED_MODULE_11__["ErrorUpdatingBrainBoot"]) {
                msg1Key = "WebSerial Update Failed - main update failed";
              } else if (_context9.t0 instanceof _rm_vca_vexcode_webserial_dist_errors__WEBPACK_IMPORTED_MODULE_11__["ErrorUpdatingBrainAssets"]) {
        ...
        return _regeneratorRuntime().wrap(function _callee10$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
            case 0:
              ...
              // const brainInfo = this._serial.getBrainInfo();
              ...
              progressHandler = function progressHandler(state, percent, msg) {
                log.debug("progressHandler:", percent, _rm_vca_vexcode_webserial__WEBPACK_IMPORTED_MODULE_4__["VEXControllerUpdateStates"][state], msg);
            ...
            case 16:
              ...
              msg1Key = "WebSerial Update Failed - unknown error";
              msg2Key = "WebSerial Update Failed - retry message";
              if (_context10.t0 instanceof _rm_vca_vexcode_webserial_dist_errors__WEBPACK_IMPORTED_MODULE_11__["WebSerialUnsupportedError"]) {
                msg1Key = "WebSerial Update Failed - webserial not supported";
              } else if (_context10.t0 instanceof _rm_vca_vexcode_webserial_dist_errors__WEBPACK_IMPORTED_MODULE_11__["NoControllerConnectedError"]) {
                msg1Key = "WebSerial Update Failed - no device";
              } else if (_context10.t0 instanceof _rm_vca_vexcode_webserial_dist_errors__WEBPACK_IMPORTED_MODULE_11__["OperationNotSupportedError"]) {
                msg1Key = "WebSerial Update Failed - not supported";
              } else if (_context10.t0 instanceof _rm_vca_vexcode_webserial_dist_errors__WEBPACK_IMPORTED_MODULE_11__["UpdateCanceled"]) {
                msg1Key = "WebSerial Update Failed - user canceled reconnect";
              } else {
                if (updateState === _rm_vca_vexcode_webserial__WEBPACK_IMPORTED_MODULE_4__["VEXControllerUpdateStates"].UpdatingRadio) {
                  msg1Key = "WebSerial Update Failed - radio update failed";
                } else if (updateState === _rm_vca_vexcode_webserial__WEBPACK_IMPORTED_MODULE_4__["VEXControllerUpdateStates"].UpdatingAtmel) {
    ...
    value: function getConnectionStateUserPort() {
      ...
      var isConnected = this.isBrainConnected() && state === _rm_vca_vexcode_webserial__WEBPACK_IMPORTED_MODULE_4__["VexWebSerialConnectionStates"].Connected;
      return isConnected ? _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["BrainConnectionState"].Connected : _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["BrainConnectionState"].Disconnected;
    }
  }, {
...
//# sourceMappingURL=e0b0fea406792a0e0205.30.bundle.js.map