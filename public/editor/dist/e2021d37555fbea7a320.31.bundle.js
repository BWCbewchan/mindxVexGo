(window["webpackJsonpwebapp"] = window["webpackJsonpwebapp"] || []).push([[31],{

/***/ "./src/HardwareInterface/IQEXPV5/V5/V5NativeUSB.ts":
/*!*********************************************************!*\
  !*** ./src/HardwareInterface/IQEXPV5/V5/V5NativeUSB.ts ***!
  \*********************************************************/
/*! exports provided: V5NativeUSB */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "V5NativeUSB", function() { return V5NativeUSB; });
...
/* harmony import */ var _V5Interface__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./V5Interface */ "./src/HardwareInterface/IQEXPV5/V5/V5Interface.ts");
...
var log = _rm_vca_logger__WEBPACK_IMPORTED_MODULE_0__["getLogger"]("V5NativeUSB");
...
_rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_7__["logger"].enableAll();
var V5NativeUSB = /*#__PURE__*/function (_V5Interface) {
  _inherits(V5NativeUSB, _V5Interface);
  var _super = _createSuper(V5NativeUSB);
  function V5NativeUSB() {
    var _this;
    _classCallCheck(this, V5NativeUSB);
    ...
    _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_7__["init"]("V5");
  ...
  _createClass(V5NativeUSB, [{
    ...
    key: "updateFirmware",
    value: function () {
      var _updateFirmware = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(progress) {
        return _regeneratorRuntime().wrap(function _callee10$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
                    ...
                    while (1) switch (_context9.prev = _context9.next) {
                      case 0:
                        ...
                        return _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_7__["updateFirmware"](function (data) {
                          if (data) {
                            if (progress) {
                              // TODO: fix this to actually support the different steps
                              progress({
            ...
            case 6:
              ...
              if (!(_context10.t0 instanceof _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_7__["NoDeviceConnectedError"])) {
                _context10.next = 12;
                break;
              }
              throw new _types_HWErrors__WEBPACK_IMPORTED_MODULE_2__["NoBrainConnectedError"]();
    ...
    value: function onConnectionUpdate(dev) {
      ...
      } else if (dev && dev.connectionType && dev.connectionType === "Radio") {
        var newBrainInfo = this.getBrainInfo();
        log.debug("updating brain info from controller connection: ", newBrainInfo);
        _GlobalEventSystem__WEBPACK_IMPORTED_MODULE_6__["fireEvent"]("HWInterface.BrainInfoUpdated", newBrainInfo);
      }
    }
  }, {
    key: "onConnect",
    value: function onConnect(dev) {
      log.info("device connected event");
      log.debug(dev);
      this.isConnected = true;
      this.onConnectionUpdate(dev);
    }
  }, {
    key: "onDisconnect",
    value: function onDisconnect(dev) {
    ...
    value: function () {
      var _checkVersionNeedsUpdate = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13(device) {
        ...
        return _regeneratorRuntime().wrap(function _callee13$(_context13) {
          while (1) switch (_context13.prev = _context13.next) {
            ...
            case 2:
              currentVersion = _context13.sent;
      ...
      function checkVersionNeedsUpdate(_x14) {
  ...
  return V5NativeUSB;
}(_V5Interface__WEBPACK_IMPORTED_MODULE_4__["V5Interface"]);


/***/ })

}]);
//# sourceMappingURL=e2021d37555fbea7a320.31.bundle.js.map