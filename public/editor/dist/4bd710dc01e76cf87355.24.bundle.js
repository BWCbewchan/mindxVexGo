(window["webpackJsonpwebapp"] = window["webpackJsonpwebapp"] || []).push([[24],{

/***/ "./src/HardwareInterface/GO123/GOWebBLE.ts":
/*!*************************************************!*\
  !*** ./src/HardwareInterface/GO123/GOWebBLE.ts ***!
  \*************************************************/
/*! exports provided: GOWebBLE */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GOWebBLE", function() { return GOWebBLE; });
...
/* harmony import */ var _rm_vca_vex_ble_device_manager__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @rm-vca/vex-ble-device-manager */ "./node_modules/@rm-vca/vex-ble-device-manager/dist_lib/src/index.js");
...
var GOWebBLE = /*#__PURE__*/function (_GO123WebBLE) {
  ...
  var _super = _createSuper(GOWebBLE);
  function GOWebBLE() {
    var _this;
  ...
  _createClass(GOWebBLE, [{
    key: "initWebBLE",
    value: function initWebBLE() {
      _rm_vca_vex_ble_device_manager__WEBPACK_IMPORTED_MODULE_3__["init"]("GO");
    }
    ...
    value: function onWebBLEPortUpdate(data) {
      ...
      data.Ports.forEach(function (port) {
        ...
        if (deviceID === _rm_vca_vex_ble_device_manager__WEBPACK_IMPORTED_MODULE_3__["VEXPortDeviceID"].Motor) {
          var motorData = port;
          var motorOut = {
        ...
        } else if (deviceID === _rm_vca_vex_ble_device_manager__WEBPACK_IMPORTED_MODULE_3__["VEXPortDeviceID"].DriveTrain) {
          var driveData = port;
          var driveOut = {
            portNumber: port.PortNumber,
            activeCommand: port.ActiveCommand,
        ...
        } else if (deviceID === _rm_vca_vex_ble_device_manager__WEBPACK_IMPORTED_MODULE_3__["VEXPortDeviceID"].Magnet) {
          var magnetData = port;
          var magnetOut = {
            portNumber: port.PortNumber,
            activeCommand: port.ActiveCommand,
        ...
        } else if (deviceID === _rm_vca_vex_ble_device_manager__WEBPACK_IMPORTED_MODULE_3__["VEXPortDeviceID"].Bumper) {
          var bumperData = port;
          var bumperOut = {
            portNumber: port.PortNumber,
            activeCommand: port.ActiveCommand,
...
//# sourceMappingURL=4bd710dc01e76cf87355.24.bundle.js.map