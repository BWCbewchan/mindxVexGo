(window["webpackJsonpwebapp"] = window["webpackJsonpwebapp"] || []).push([[29],{

/***/ "./src/HardwareInterface/IQEXPV5/IQ/IQNativeUSB.ts":
/*!*********************************************************!*\
  !*** ./src/HardwareInterface/IQEXPV5/IQ/IQNativeUSB.ts ***!
  \*********************************************************/
/*! exports provided: IQNativeUSB */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IQNativeUSB", function() { return IQNativeUSB; });
...
/* harmony import */ var _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @rm-vca/vexcode-device-manager */ "./node_modules/@rm-vca/vexcode-device-manager/dist/src/index.js");
/* harmony import */ var _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _IQInterface__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./IQInterface */ "./src/HardwareInterface/IQEXPV5/IQ/IQInterface.ts");
...
/* harmony import */ var _RobotConfiguration_Manager_RobotConfigManager__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../RobotConfiguration/Manager/RobotConfigManager */ "./src/RobotConfiguration/Manager/RobotConfigManager.ts");
...
var log = _rm_vca_logger__WEBPACK_IMPORTED_MODULE_0__["getLogger"]("IQNativeUSB");
...
var IQNativeUSB = /*#__PURE__*/function (_IQInterface) {
  _inherits(IQNativeUSB, _IQInterface);
  var _super = _createSuper(IQNativeUSB);
  function IQNativeUSB() {
    var _this;
    _classCallCheck(this, IQNativeUSB);
    ...
    _defineProperty(_assertThisInitialized(_this), "dm", _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_3__);
    ...
    _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_3__["init"]("IQ");
    _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_3__["enableTerminal"](function (data) {
    ...
    _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_3__["addOnDeviceConnectionHandler"](_this.onConnect);
    _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_3__["addOnDeviceDisconnectionHandler"](_this.onDisconnect);
    return _this;
  }

  //#region connection control
  _createClass(IQNativeUSB, [{
    key: "openConnection",
    value: function () {
    ...
    value: function getConnectionState() {
      log.debug("getConnectionState:", this.isConnected);
      if (this.isUpdating) {
        return _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["BrainConnectionState"].UpdatingFirmware;
      }
      return this.isConnected ? _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["BrainConnectionState"].Connected : _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["BrainConnectionState"].Disconnected;
    }
    ...
    value: function getBrainInfo() {
      ...
      var rawBrainInfo = _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_3__["getBrainInfo"]();
      if (rawBrainInfo === undefined) {
        return {
          serial: 0,
          version: new _VexVersion__WEBPACK_IMPORTED_MODULE_5__["VexVersion"](0, 0, 0, 0),
          versionFW: new _VexVersion__WEBPACK_IMPORTED_MODULE_5__["VexVersion"](0, 0, 0, 0),
          name: "",
          deviceType: _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["VexDeviceType"].VEXIQ,
          connectionMethod: _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["VexConnectionMethod"].USB,
          brainConnected: false,
          canUpdate: false,
          needsFWUpdate: _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["UpdateNeededOptions"].Unsure
        };
      }
      log.debug("rawBrainInfo:", rawBrainInfo);
      var tmpVersion = _VexVersion__WEBPACK_IMPORTED_MODULE_5__["VexVersion"].fromString(rawBrainInfo.softwareVersion);
      var hasBrainVersion = tmpVersion && tmpVersion.toInternalString() !== "0.0.0.b0";
      var isIQ1 = rawBrainInfo.product === "IQ";
      var IQ1FWVersion = this.getCahcedIQ1ServerFirmwareVersion();
      var needsFWUpdateIQ1 = this.getUpdatedNeededFromServer(IQ1FWVersion, tmpVersion);
      var needsFWUpdateIQ2 = rawBrainInfo.updateNeeded || rawBrainInfo.isDFUMode ? _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["UpdateNeededOptions"].NeedsUpdate : _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["UpdateNeededOptions"].UpToDate;
      var brainInfo = {
        serial: parseInt(rawBrainInfo.serialNumber, 10),
        version: tmpVersion,
        versionFW: tmpVersion,
        name: rawBrainInfo.name,
        team: rawBrainInfo.team,
        deviceType: isIQ1 ? _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["VexDeviceType"].VEXIQ : _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["VexDeviceType"].VEXIQ2,
        connectionMethod: rawBrainInfo.connectionType === "USB" ? _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["VexConnectionMethod"].USB : _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["VexConnectionMethod"].RC_Radio,
        brainConnected: rawBrainInfo.brainStatus,
        needsFWUpdate: hasBrainVersion ? isIQ1 ? needsFWUpdateIQ1 : needsFWUpdateIQ2 : _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["UpdateNeededOptions"].Unsure,
        canUpdate: !isIQ1,
      ...
      var _setBrainName = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(name) {
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 2:
              return _context3.abrupt("return", _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_3__["setBrainName"](name));
            case 3:
            case "end":
    ...
    key: "play",
    value: function () {
      var _play = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(slot) {
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 6:
              _context4.next = 8;
              return _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_3__["runProgram"](slot);
            case 8:
            ...
            case 11:
              ...
              throw new RangeError("slot must be between 0 and 3 inclusive");
            case 13:
              _context4.next = 15;
              return _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_3__["runProgram"](slot + 1);
            case 15:
              log.info("run command sent");
            case 16:
    ...
    value: function stop() {
      ...
      return new Promise(function (resolve, reject) {
        try {
          _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_3__["stopProgram"]().then(function () {
            return resolve(true);
          })["catch"](function (err) {
            log.error("stopping program rejected:", err);
            resolve(false);
          });
        } catch (err) {
    ...
    key: "downloadProgram",
    value: function () {
      var _downloadProgram = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(slot, projectName, language, data, progressCallback) {
        var isBlocks, isPython, ideIQ2, programInfo, deviceManagerDownloadCallback;
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              ...
              isPython = _AppInfo__WEBPACK_IMPORTED_MODULE_9__["appState"].getAppState().lang === "python";
              ideIQ2 = isBlocks ? "Blocks" : isPython ? "Python" : "C++"; // tslint:disable: trailing-comma
              programInfo = {
                slot: slot,
                name: projectName,
                desc: "",
                icon: this.targetIsIQ2 ? isBlocks ? _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["IQIcons"].blocksIcon : isPython ? _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["IQIcons"].pythonIcon : _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["IQIcons"].cppIcon : _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["IQIcons"].iq1Icon,
                ports: [,,,,,,,,,,,,,,,,,,,,,,,],
                triport_22: [,,,,,,,,],
                controller_1: [],
                controller_2: [],
                ide: this.targetIsIQ2 ? ideIQ2 : undefined,
                progress: null,
                autorun: false,
                language: language
              };
              _RobotConfiguration_Manager_RobotConfigManager__WEBPACK_IMPORTED_MODULE_6__["currentConfiguration"].forEach(function (dev) {
                log.warn("device:", dev);
                var devType = dev.deviceType["class"];
                if (devType === "controller") {
                  return;
                } else if (devType === "smartdrive") {
                  var driveType = dev.setting ? dev.setting.type : null;
                  var ports;
                  switch (driveType) {
                    case "4-motor":
                      ports = dev.port;
                      programInfo.ports[ports[0]] = "motor";
                      programInfo.ports[ports[1]] = "motor";
                      programInfo.ports[ports[2]] = "motor";
                      programInfo.ports[ports[3]] = "motor";
                      if (ports[4] !== 0) {
                        programInfo.ports[ports[4]] = "gyro";
                      }
                      break;
                    case "2-motor":
                    default:
                      ...
                      programInfo.ports[ports[1]] = "motor";
                      if (ports[2] !== 0) {
                        programInfo.ports[ports[2]] = "gyro";
                      }
                  }
                } else if (devType === "colorsensor") {
                  programInfo.ports[dev.port[0]] = "color";
                } else if (devType === "motor_group") {
                  var _ports;
                  _ports = dev.port;
                  programInfo.ports[_ports[0]] = "motor";
                  programInfo.ports[_ports[1]] = "motor";
                } else {
                  programInfo.ports[dev.port[0]] = devType;
                }
              });
              log.debug("programInfo:", programInfo);
              _context6.prev = 7;
                    ...
                    while (1) switch (_context5.prev = _context5.next) {
                      case 0:
                        ...
                        disconnectHandler = function disconnectHandler(dev) {
                          ...
                          resolve(false);
                          _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_3__["removeOnDeviceDisconnectionHandler"](disconnectHandler);
                        };
                        _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_3__["addOnDeviceDisconnectionHandler"](disconnectHandler);
                        _context5.next = 5;
                        return _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_3__["downloadProgram"](Object(_helpers__WEBPACK_IMPORTED_MODULE_8__["forceBuffer"])(data), programInfo, deviceManagerDownloadCallback);
                      case 5:
            ...
            case 12:
              ...
              if (!(_context6.t0 instanceof _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_3__["NoDeviceConnectedError"])) {
                _context6.next = 18;
                break;
              }
              throw new _types_HWErrors__WEBPACK_IMPORTED_MODULE_2__["NoBrainConnectedError"]();
      ...
      function downloadProgram(_x3, _x4, _x5, _x6, _x7) {
        ...
        var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(resolve, reject) {
          ...
          return _regeneratorRuntime().wrap(function _callee7$(_context7) {
            while (1) switch (_context7.prev = _context7.next) {
              case 0:
                if (!_this2.targetIsIQ2) {
                  resolve(false);
                }
                _context7.prev = 1;
                _context7.next = 4;
                return _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_3__["checkPythonVM"]();
              case 4:
              ...
              case 9:
                ...
                log.warn("getPythonVMValid error: ", _context7.t0);
                resolve(false);
              case 13:
              case "end":
    ...
    value: function canUpdateFirmware() {
      return this.targetIsIQ2 && this.getBrainInfo().connectionMethod === _types_HWEnums__WEBPACK_IMPORTED_MODULE_1__["VexConnectionMethod"].USB;
    }
  }, {
        ...
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
                  ...
                  return _regeneratorRuntime().wrap(function _callee8$(_context8) {
                    while (1) switch (_context8.prev = _context8.next) {
                      case 0:
                        ...
                        _this3._didTryFirmwareUpdate = true;
                        _context8.next = 7;
                        return _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_3__["updateFirmware"](function (data) {
                          if (data) {
                            if (progress) {
                              progress({
            ...
            case 6:
              ...
              if (!(_context9.t0 instanceof _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_3__["NoDeviceConnectedError"])) {
                _context9.next = 13;
                break;
              }
              throw new _types_HWErrors__WEBPACK_IMPORTED_MODULE_2__["NoBrainConnectedError"]();
      ...
      return new Promise(function (resolve, reject) {
        try {
          ...
          var _disconnectHandler = function _disconnectHandler(dev) {
            log.warn("device disconnected during firmware update...");
            resolve(false);
            _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_3__["removeOnDeviceDisconnectionHandler"](_disconnectHandler);
          };
          _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_3__["addOnDeviceDisconnectionHandler"](_disconnectHandler);
          ...
          _this4._didTryControllerFirmwareUpdate = true;
          _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_3__["updateFirmwareController"](progressHandler, undefined, isDFU).then(function (res) {
    ...
    value: function () {
      var _closeConnectionUserPort = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11() {
    ...
    value: function onConnect(device) {
      ...
      if (!this.didDeviceRecheck && brainInfo.brainConnected && brainInfo.serial === 0) {
        ...
        setTimeout(function () {
          _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_3__["refreshDevices"]();
        }, 250);
    ...
    value: function onDisconnect(device) {
      ...
      log.debug("onDisconnect:", this.isConnected);
      this.triggerConnectionUpdate(device);
    }
    //#endregion events
    ...
    value: function getLowLevelLogger() {
      ...
      return _rm_vca_vexcode_device_manager__WEBPACK_IMPORTED_MODULE_3__["logger"];
    }
    //#endregion low-level logger
  }]);
  return IQNativeUSB;
}(_IQInterface__WEBPACK_IMPORTED_MODULE_4__["IQInterface"]);


/***/ })

}]);
//# sourceMappingURL=1abab4d2bb4f04342619.29.bundle.js.map