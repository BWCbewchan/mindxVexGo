...
Blockly.FieldTextInput.prototype.showInlineEditor_ = function(quietInput) {
  ...
  if (!quietInput) {
    ...
    // RM Code Start
    // for iPad, we need to adjust the style after display to make sure that the text input is never hidden by the keyboard
    if (Blockly.utils.userAgent.IPAD) {
      var setInputStyle = function(style) {
        console.log("this.htmlInput_.style.display:", this.htmlInput_.style.display, style);
        this.htmlInput_.style.display = style;
      }
      setInputStyle = setInputStyle.bind(this);
