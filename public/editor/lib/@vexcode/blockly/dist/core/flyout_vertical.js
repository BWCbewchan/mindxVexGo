...
Blockly.VerticalFlyout.prototype.setMetrics_ = function(xyRatio) {
  ...
  // RM Code Start
  this.updateCategorySelectionByScrollPosition();
  // RM Code End
};

// RM Code Start
Blockly.VerticalFlyout.prototype.updateCategorySelectionByScrollPosition = function() {
  ...
  if (this.targetWorkspace.toolboxPosition == this.toolboxPosition_) {
    ...
    if (targetWorkspaceMetrics.toolboxWidth) {
      if (this.toolboxPosition_ == Blockly.TOOLBOX_AT_LEFT) {
        ...
        // RM Code Start
        // var x = targetWorkspaceMetrics.viewWidth - this.width_; // Old code: subtracting this.width shifted toolbox to the right in arabic
        var x = targetWorkspaceMetrics.viewWidth; // Removing it fixed it. VC-8571
        // RM Code End
      }
    } else {
      if (this.toolboxPosition_ == Blockly.TOOLBOX_AT_LEFT) {
...
Blockly.VerticalFlyout.prototype.layout_ = function(contents, gaps) {
  // RM Code Start
  this.workspace_.scale = this.targetWorkspace.scaleStart;
  // RM Code End
