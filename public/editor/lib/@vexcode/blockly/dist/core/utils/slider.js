 ...
 * @namespace
 */
goog.provide('Blockly.utils.Slider');
 ...
 * @constructor
 */
Blockly.utils.Slider = function (x, y, width, svgParent, opt_changeFunc) {
  this.KNOB_Y_ = y - 12;
  ...
  */
  ...
  Blockly.utils.Slider.bindEvent_(this.knobTarget_, 'mousedown', this, this.knobMouseDown_);
  Blockly.utils.Slider.bindEvent_(this.knobTarget_, 'touchstart', this, this.knobMouseDown_);
  Blockly.utils.Slider.bindEvent_(this.trackTarget_, 'mousedown', this, this.rectMouseDown_);
  Blockly.utils.Slider.bindEvent_(this.SVG_, 'mouseup', null, Slider.knobMouseUp_);
  Blockly.utils.Slider.bindEvent_(this.SVG_, 'touchend', null, Slider.knobMouseUp_);
  Blockly.utils.Slider.bindEvent_(this.SVG_, 'mousemove', null, Slider.knobMouseMove_);
  Blockly.utils.Slider.bindEvent_(this.SVG_, 'touchmove', null, Slider.knobMouseMove_);
  Blockly.utils.Slider.bindEvent_(document, 'mouseover', null, Slider.mouseOver_);
};


Blockly.utils.Slider.SVG_NS_ = 'http://www.w3.org/2000/svg';

Blockly.utils.Slider.activeSlider_ = null;
Blockly.utils.Slider.startMouseX_ = 0;
Blockly.utils.Slider.startKnobX_ = 0;
 ...
 * @private
 */
Blockly.utils.Slider.prototype.knobMouseDown_ = function (e) {
  if (e.type == 'touchstart') {
    if (e.changedTouches.length != 1) {
      return;
    }
    Blockly.utils.Slider.touchToMouse_(e)
  }
  Blockly.utils.Slider.activeSlider_ = this;
  Blockly.utils.Slider.startMouseX_ = this.mouseToSvg_(e).x;
  Blockly.utils.Slider.startKnobX_ = 0;
  var transform = this.knob_.getAttribute('transform');
  if (transform) {
    var r = transform.match(/translate\(\s*([-\d.]+)/);
    if (r) {
      Blockly.utils.Slider.startKnobX_ = Number(r[1]);
    }
  }
 ...
 * @private
 */
Blockly.utils.Slider.knobMouseUp_ = function (e) {
  Blockly.utils.Slider.activeSlider_ = null;
};
 ...
 * @private
 */
Blockly.utils.Slider.mouseOver_ = function (e) {
  if (!Blockly.utils.Slider.activeSlider_) {
    return;
  }
  var node = e.target;
  // Find the root SVG object.
  do {
    if (node == Blockly.utils.Slider.activeSlider_.SVG_) {
      return;
    }
  } while (node = node.parentNode);
  Blockly.utils.Slider.knobMouseUp_(e);
};
 ...
 * @private
 */
 Blockly.utils.Slider.knobMouseMove_ = function (e) {
 ...
 * @private
 */
 Blockly.utils.Slider.prototype.rectMouseDown_ = function (e) {
  if (e.type == 'touchstart') {
    if (e.changedTouches.length != 1) {
      return;
    }
 ...
 */
 Blockly.utils.Slider.prototype.getValue = function () {
  return this.value_;
};
 ...
 */
Blockly.utils.Slider.prototype.animateValue = function (value) {
 ...
 * @param {number} value New value.
 */
Blockly.utils.Slider.prototype.setValue = function (value) {
 ...
 * @private
 */
Blockly.utils.Slider.prototype.mouseToSvg_ = function (e) {
 ...
 * @private
 */
Blockly.utils.Slider.bindEvent_ = function (node, name, thisObject, func) {
 ...
 */
Blockly.utils.Slider.touchToMouse_ = function (e) {
