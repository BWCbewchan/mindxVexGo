...
/**
 * 
 * @typedef {Function} BlockGeneratorFunction
...
/**
 * 
 * @typedef {Object.<string, BlockGeneratorFunction} BlocklyGeneratorBlocks
 */
...
Blockly.Generator.prototype.workspaceToCode = function(workspace) {
  ...
  // RM - build the my block definitions first
  for (var x = 0, block; block = blocks[x]; x++) {
    if (block.type === "procedures_definition" && !block.disabled) {
  ...
  // build everything else after the my block definitions
  for (var i = 0, block; (block = blocks[i]); i++) {
    // RM code start
    // skip if not a hat block or it is not enabled
    if (!block.isHatBlock() || !block.isEnabled()) {
      continue;
    }
    // RM code end
 ...
 * @protected
 */
Blockly.Generator.prototype.provideFunction_ = function(desiredName, code, isHiddenFunc) {
  if (!this.definitions_[desiredName]) {
    ...
    // RM - add way to hide select functions for code gen output
...
//#region RM added code
/**
 * Set whether the generator should include unused
 * user variables in the generated code.
 * @type {boolean}
 */
Blockly.Generator.prototype.INCLUDE_UNUSED_VARS = true;

/**
 * Set whether the generator should include a wait in loops.
 * @type {boolean}
 */
Blockly.Generator.prototype.INCLUDE_LOOP_WAIT = true;

//#region VEXcode injection properties
/**
 * string to add for starting RC generated task
 */
Blockly.Generator.prototype.RC_TASK_START = "";

/**
 * string to add for stoping RC generated task
 */
Blockly.Generator.prototype.RC_TASK_STOP = "";

/**
 * string to add for calibrating the drivetrain
 */
Blockly.Generator.prototype.DRIVETRAIN_CALIBRATE = "";

/**
 * string to add to int main before any events get setup/registered
 */
Blockly.Generator.prototype.preEventRegistration = "";

/**
 * string to add to int main after any events get setup/registered
 */
Blockly.Generator.prototype.postEventRegistration = "";
//#endregion VEXcode injection properties
 ...
 * @private
 */
 Blockly.Generator.prototype.provideMyBlocksFunction_ = function(desiredName, code) {
  if (!this.definitions_[desiredName]) {
    var functionName = this.variableDB_.getName(desiredName,
 ...
 * @return {string} Generated code or '' if no blocks are connected.
 */
Blockly.Generator.prototype.eventStackToCode = function(block) {
 ...
 */
Blockly.Generator.prototype.addDriverEventFunction = function(block, name, branch, eventSetter) {
  console.warn('Not expected to reach Blockly.Generator.prototype.addDriverEventFunction function. ' +
      'A generator implementation call was expected to be called instead.');
};
 ...
 * @param {string} eventSetter the code called to tell the event to call the function
 */
Blockly.Generator.prototype.addAutonEventFunction = function(block, name, branch, eventSetter) {
  console.warn('Not expected to reach Blockly.Generator.prototype.addAutonEventFunction function. ' +
      'A generator implementation call was expected to be called instead.');
};
 ...
 * @param {string} eventSetter the code called to tell the event to call the function
 */
Blockly.Generator.prototype.addSystemEventFunction = function(block, name, branch, eventSetter) {
  console.warn('Not expected to reach Blockly.Generator.prototype.addSystemEventFunction function. ' +
      'A generator implementation call was expected to be called instead.');
};
 ...
 */
Blockly.Generator.prototype.addSystemEventArgumentFunction = function(block, name, branch, eventSetter, arg) {
  console.warn('Not expected to reach Blockly.Generator.prototype.addSystemEventArgumentFunction function. ' +
      'A generator implementation call was expected to be called instead.');
};
 ...
 * @param {string} eventSetter the code called to tell the event to call the function
 */
Blockly.Generator.prototype.addUserEventFunction = function(block, name, branch, eventSetter) {
  console.warn('Not expected to reach Blockly.Generator.prototype.addUserEventFunction function. ' +
      'A generator implementation call was expected to be called instead.');
};
 ...
 * @param {string} branch the branch code for the event
 */
Blockly.Generator.prototype.addWhenStartedFunction = function(block, branch) {
  console.warn('Not expected to reach Blockly.Generator.prototype.addWhenStartedFunction function. ' +
      'A generator implementation call was expected to be called instead.');
};
//#endregion RM added code