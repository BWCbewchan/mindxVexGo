...
goog.provide('Blockly.VexcodeToolboxCategory');
 ...
 */
Blockly.VexcodeToolboxCategory = function(categoryDef, toolbox, opt_parent) {
  Blockly.VexcodeToolboxCategory.superClass_.constructor.call(
   ...
   * @type {!Blockly.VexcodeToolboxCategory.CssConfig}
   * @protected
   */
...
Blockly.utils.object.inherits(Blockly.VexcodeToolboxCategory, Blockly.VexcodeToolboxItem);
 ...
 *          }}
 */
Blockly.VexcodeToolboxCategory.CssConfig;

/**
 * Name used for registering a toolbox category.
 * @const {string}
 */
Blockly.VexcodeToolboxCategory.registrationName = 'category';

/**
 * The number of pixels to move the category over at each nested level.
 * @type {number}
 */
Blockly.VexcodeToolboxCategory.nestedPadding = 19;

/**
 * The width in pixels of the strip of colour next to each category.
 * @type {number}
 */
Blockly.VexcodeToolboxCategory.borderWidth = 8;
 ...
 * @type {string}
 */
Blockly.VexcodeToolboxCategory.defaultBackgroundColour = '#57e';

/**
 * Creates an object holding the default classes for a category.
 * @return {!Blockly.VexcodeToolboxCategory.CssConfig} The configuration object holding
 *    all the CSS classes for a category.
 * @protected
 */
Blockly.VexcodeToolboxCategory.prototype.makeDefaultCssConfig_ = function() {
  return {
 ...
 * @protected
 */
Blockly.VexcodeToolboxCategory.prototype.parseContents_ = function(categoryDef) {
 ...
 * @override
 */
Blockly.VexcodeToolboxCategory.prototype.init = function() {
  this.createDom_();
 ...
 * @protected
 */
Blockly.VexcodeToolboxCategory.prototype.createDom_ = function() {
 ...
 * @protected
 */
Blockly.VexcodeToolboxCategory.prototype.createContainer_ = function() {
 ...
 * @protected
 */
Blockly.VexcodeToolboxCategory.prototype.createRowContainer_ = function() {
  var rowDiv = document.createElement('div');
  Blockly.utils.dom.addClass(rowDiv, this.cssConfig_['row']);
  var nestedPadding = Blockly.VexcodeToolboxCategory.nestedPadding * this.getLevel();
 ...
 * @protected
 */
Blockly.VexcodeToolboxCategory.prototype.createRowContentsContainer_ = function() {
 ...
 * @protected
 */
Blockly.VexcodeToolboxCategory.prototype.createIconDom_ = function() {
 ...
 * @protected
 */
Blockly.VexcodeToolboxCategory.prototype.createLabelDom_ = function(name) {
 ...
 * @public
 */
Blockly.VexcodeToolboxCategory.prototype.refreshTheme = function() {
 ...
 * @protected
 */
Blockly.VexcodeToolboxCategory.prototype.addColourBorder_ = function(colour) {
  if (colour) {
    var border = Blockly.VexcodeToolboxCategory.borderWidth + 'px solid ' +
        (colour || '#ddd');
 ...
 * @protected
 */
Blockly.VexcodeToolboxCategory.prototype.getColour_ = function(categoryDef) {
 ...
 * @private
 */
Blockly.VexcodeToolboxCategory.prototype.getColourfromStyle_ = function(styleName) {
 ...
 * @private
 */
Blockly.VexcodeToolboxCategory.prototype.parseColour_ = function(colourValue) {
 ...
 * @protected
 */
Blockly.VexcodeToolboxCategory.prototype.openIcon_ = function(iconDiv) {
  if (!iconDiv) {
    return;
  }
 ...
 * @protected
 */
Blockly.VexcodeToolboxCategory.prototype.closeIcon_ = function(iconDiv) {
  if (!iconDiv) {
    return;
  }
 ...
 * @protected
 */
Blockly.VexcodeToolboxCategory.prototype.setVisible_ = function(isVisible) {
 ...
 * Hide the category.
 */
Blockly.VexcodeToolboxCategory.prototype.hide = function() {
 ...
 * expanded.
 */
Blockly.VexcodeToolboxCategory.prototype.show = function() {
 ...
 * @public
 */
Blockly.VexcodeToolboxCategory.prototype.isVisible = function() {
 ...
 * @protected
 */
Blockly.VexcodeToolboxCategory.prototype.allAncestorsExpanded_ = function() {
  var category = this;
 ...
 * @override
 */
Blockly.VexcodeToolboxCategory.prototype.isSelectable = function() {
 ...
 * @public
 */
Blockly.VexcodeToolboxCategory.prototype.onClick = function(_e) {
  // No-op
};
 ...
 * @public
 */
Blockly.VexcodeToolboxCategory.prototype.setSelected = function(isSelected) {
  if (isSelected) {
    var defaultColour = this.parseColour_(
        Blockly.VexcodeToolboxCategory.defaultBackgroundColour);
 ...
 */
Blockly.VexcodeToolboxCategory.prototype.setDisabled = function(isDisabled) {
 ...
 * @public
 */
Blockly.VexcodeToolboxCategory.prototype.getName = function() {
  return this.name_;
};
 ...
 * @override
 */
Blockly.VexcodeToolboxCategory.prototype.getParent = function() {
  return this.parent_;
};
 ...
 * @override
 */
Blockly.VexcodeToolboxCategory.prototype.getDiv = function() {
  return this.htmlDiv_;
};
 ...
 * @public
 */
Blockly.VexcodeToolboxCategory.prototype.getContents = function() {
 ...
 * @public
 */
Blockly.VexcodeToolboxCategory.prototype.updateFlyoutContents = function(contents) {
  this.flyoutItems_ = [];
 ...
 * @override
 */
Blockly.VexcodeToolboxCategory.prototype.dispose = function() {
...
Blockly.registry.register(Blockly.registry.Type.TOOLBOX_ITEM,
    Blockly.VexcodeToolboxCategory.registrationName, Blockly.VexcodeToolboxCategory);
