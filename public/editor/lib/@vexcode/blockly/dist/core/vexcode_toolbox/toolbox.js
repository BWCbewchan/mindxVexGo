...
goog.provide('Blockly.VexcodeToolbox');

goog.require('Blockly.CollapsibleVexcodeToolboxCategory');
 ...
 */
Blockly.VexcodeToolbox = function(workspace) {
  /**
 ...
 * @public
 */
Blockly.VexcodeToolbox.prototype.init = function() {
 ...
 * @protected
 */
Blockly.VexcodeToolbox.prototype.createDom_ = function(workspace) {
  var svg = workspace.getParentSvg();
 ...
 * @protected
 */
Blockly.VexcodeToolbox.prototype.createContainer_ = function() {
 ...
 * @protected
 */
Blockly.VexcodeToolbox.prototype.createContentsContainer_ = function() {
 ...
 * @protected
 */
Blockly.VexcodeToolbox.prototype.attachEvents_ = function(container,
    contentsContainer) {
  ...
  // RM Code Start
  // RM we do not need the keyboard controls...
 ...
 * @protected
 */
Blockly.VexcodeToolbox.prototype.onClick_ = function(e) {
 ...
 * @protected
 */
Blockly.VexcodeToolbox.prototype.onKeyDown_ = function(e) {
  var handled = false;
  switch (e.keyCode) {
 ...
 * @protected
 */
Blockly.VexcodeToolbox.prototype.createFlyout_ = function() {
  var workspace = this.workspace_;
 ...
 * @package
 */
Blockly.VexcodeToolbox.prototype.render = function(toolboxDef) {
 ...
 * @protected
 */
Blockly.VexcodeToolbox.prototype.renderContents_ = function(toolboxDef) {
 ...
 * @private
 */
Blockly.VexcodeToolbox.prototype.createToolboxItem_ = function(toolboxItemDef, fragment) {
 ...
 * @protected
 */
Blockly.VexcodeToolbox.prototype.addToolboxItem_ = function(toolboxItem) {
 ...
 * @public
 */
Blockly.VexcodeToolbox.prototype.getToolboxItems = function() {
 ...
 * @package
 */
Blockly.VexcodeToolbox.prototype.addStyle = function(style) {
 ...
 * @package
 */
Blockly.VexcodeToolbox.prototype.removeStyle = function(style) {
 ...
 * @public
 */
Blockly.VexcodeToolbox.prototype.getClientRect = function() {
  if (!this.HtmlDiv) {
    return null;
  }
 ...
 * @public
 */
Blockly.VexcodeToolbox.prototype.getToolboxItemById = function(id) {
 ...
 * @public
 */
Blockly.VexcodeToolbox.prototype.getWidth = function() {
  return this.width_;
};
 ...
 * @public
 */
Blockly.VexcodeToolbox.prototype.getHeight = function() {
  return this.height_;
};
 ...
 * @public
 */
Blockly.VexcodeToolbox.prototype.getFlyout = function() {
  return this.flyout_;
};
 ...
 * @public
 */
Blockly.VexcodeToolbox.prototype.getWorkspace = function() {
 ...
 * @public
 */
Blockly.VexcodeToolbox.prototype.getSelectedItem = function() {
 ...
 * @public
 */
Blockly.VexcodeToolbox.prototype.getPreviouslySelectedItem = function() {
 ...
 * @public
 */
Blockly.VexcodeToolbox.prototype.isHorizontal = function() {
 ...
 * @public
 */
Blockly.VexcodeToolbox.prototype.position = function() {
  ...
  if (this.horizontalLayout_) {
    ...
    if (this.toolboxPosition == Blockly.VexcodeToolbox_AT_TOP) {  // Top
      toolboxDiv.style.top = '0';
    } else {  // Bottom
      toolboxDiv.style.bottom = '0';
    }
  } else {
    if (this.toolboxPosition == Blockly.VexcodeToolbox_AT_RIGHT) {  // Right
 ...
 * @package
 */
Blockly.VexcodeToolbox.prototype.handleToolboxItemResize = function() {
  ...
  var newX = this.toolboxPosition == Blockly.VexcodeToolbox_AT_LEFT ?
      workspace.scrollX + rect.width : workspace.scrollX;
  var newY = this.toolboxPosition == Blockly.VexcodeToolbox_AT_TOP ?
 ...
 * @public
 */
Blockly.VexcodeToolbox.prototype.clearSelection = function() {
 ...
 * @package
 */
Blockly.VexcodeToolbox.prototype.refreshTheme = function() {
  for (var i = 0; i < this.contents_.length; i++) {
 ...
 * @public
 */
Blockly.VexcodeToolbox.prototype.refreshSelection = function() {
 ...
 * @public
 */
Blockly.VexcodeToolbox.prototype.setVisible = function(isVisible) {
 ...
 * @public
 */
Blockly.VexcodeToolbox.prototype.setSelectedItem = function(newItem) {
 ...
 * @protected
 */
Blockly.VexcodeToolbox.prototype.shouldDeselectItem_ = function(oldItem, newItem) {
 ...
 * @protected
 */
Blockly.VexcodeToolbox.prototype.shouldSelectItem_ = function(oldItem, newItem) {
 ...
 * @protected
 */
Blockly.VexcodeToolbox.prototype.deselectItem_ = function(item) {
  this.selectedItem_ = null;
 ...
 * @protected
 */
Blockly.VexcodeToolbox.prototype.selectItem_ = function(oldItem, newItem) {
 ...
 * @public
 */
Blockly.VexcodeToolbox.prototype.selectItemByPosition = function(position) {
 ...
 * @protected
 */
Blockly.VexcodeToolbox.prototype.updateFlyout_ = function(oldItem, newItem) {
 ...
 * @private
 */
Blockly.VexcodeToolbox.prototype.fireSelectEvent_ = function(oldItem, newItem) {
 ...
 * @package
 */
Blockly.VexcodeToolbox.prototype.onBlocklyAction = function(action) {
 ...
 * @private
 */
Blockly.VexcodeToolbox.prototype.selectParent_ = function() {
 ...
 * @private
 */
Blockly.VexcodeToolbox.prototype.selectChild_ = function() {
  if (!this.selectedItem_ || !this.selectedItem_.isCollapsible()) {
    return false;
  }
  var collapsibleItem = /** @type {Blockly.ICollapsibleToolboxItem} */
 ...
 * @private
 */
Blockly.VexcodeToolbox.prototype.selectNext_ = function() {
  if (!this.selectedItem_) {
    return false;
  }
 ...
 * @private
 */
Blockly.VexcodeToolbox.prototype.selectPrevious_ = function() {
  if (!this.selectedItem_) {
    return false;
  }
 ...
 * @public
 */
Blockly.VexcodeToolbox.prototype.dispose = function() {
...
Blockly.registry.register(Blockly.registry.Type.TOOLBOX,
    Blockly.registry.DEFAULT, Blockly.VexcodeToolbox);
