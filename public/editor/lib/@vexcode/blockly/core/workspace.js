 ...
 */
Blockly.Workspace.prototype.createVariable = function(name, opt_type, opt_id, opt_arrayLength, opt_arrayWidth) {
  return this.variableMap_.createVariable(name, opt_type, opt_id, opt_arrayLength, opt_arrayWidth);
};
 ...
 */
Blockly.Workspace.prototype.clearRedoOnly = function() {
  this.redoStack_.length = 0;
  // // Stop any events already in the firing queue from being undoable.
  // Blockly.Events.clearPendingUndo();
};
