...
Blockly.zelos.ConstantProvider = function() {
   ...
   * @type {string}
   */
  this.HIGHLIGHTED_GLOW_COLOUR = '#ADFF2F';

  /**
   * The size of the highlighted glow.
   * @type {number}
   */
  this.HIGHLIGHTED_GLOW_SIZE = 0.7;
  // RM Code End
...
Blockly.zelos.ConstantProvider.prototype.setDynamicProperties_ = function(
  ...
  // // RM Code Start
  // this.HIGHLIGHTED_GLOW_COLOUR =
  //     theme.getComponentStyle('highlightedGlowColour') ||
  //     this.SELECTED_GLOW_COLOUR;
  // var highlightedGlowSize =
  //     Number(theme.getComponentStyle('highlightedGlowSize'));
  // this.HIGHLIGHTED_GLOW_SIZE =
  //     highlightedGlowSize && !isNaN(highlightedGlowSize) ?
  //     highlightedGlowSize : this.SELECTED_GLOW_SIZE;
  // // RM Code End
...
Blockly.zelos.ConstantProvider.prototype.createDom = function(svg,
  ...
  */
  ...
  // Using a dilate distorts the block shape.
  // Instead use a gaussian blur, and then set all alpha to 1 with a transfer.
  var highlightedGlowFilter = Blockly.utils.dom.createSvgElement(
      Blockly.utils.Svg.FILTER,
      {
  ...
  Blockly.utils.dom.createSvgElement(
      ...
      {
        'in': 'SourceGraphic',
        'stdDeviation': this.HIGHLIGHTED_GLOW_SIZE
      },
      highlightedGlowFilter);
  // Set all gaussian blur pixels to 1 opacity before applying flood
  var highlightedComponentTransfer = Blockly.utils.dom.createSvgElement(
      Blockly.utils.Svg.FECOMPONENTTRANSFER, {
        'result': 'outBlur'
      }, highlightedGlowFilter);
  Blockly.utils.dom.createSvgElement(
      ...
      highlightedComponentTransfer);
  // Color the highlight
  Blockly.utils.dom.createSvgElement(
      Blockly.utils.Svg.FEFLOOD,
      {
        'flood-color': this.HIGHLIGHTED_GLOW_COLOUR,
        'flood-opacity': 1,
        'result': 'outColor'
      },
      highlightedGlowFilter);
  Blockly.utils.dom.createSvgElement(
      ...
      highlightedGlowFilter);
  this.highlightedGlowFilterId = highlightedGlowFilter.id;
  this.highlightedGlowFilter_ = highlightedGlowFilter;
  // RM Code End
