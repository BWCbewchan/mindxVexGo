...
Blockly.blockRendering.ConstantProvider = function() {
   ...
   * @type {number}
   */
  this.FIELD_MUTATORTOGGLE_SVG_ARROW_SIZE = 20;
...
Blockly.blockRendering.ConstantProvider.prototype.init = function() {
   ...
   * @type {!Object}
   */
  this.LARGE_OUTSIDE_CORNERS = this.makeLargeOutsideCorners();
  // RM Code End
};
 ...
 * @package
 */
 Blockly.blockRendering.ConstantProvider.prototype.makeLargeOutsideCorners = function() {
  var radius = this.START_HAT_HEIGHT;
  /**
   * SVG path for drawing the rounded top-left corner.
   * @const
   */
