 ...
 */
Blockly.BlockSvg.prototype.generateContextMenu = function(e) {// RM Code Changes
  if (this.workspace.options.readOnly || !this.contextMenu) {
    return null;
  }
  var menuOptions = Blockly.ContextMenuRegistry.registry.getContextMenuOptions(
      Blockly.ContextMenuRegistry.ScopeType.BLOCK, {block: this, event: e});// RM Code Changes
...
Blockly.BlockSvg.prototype.showContextMenu = function(e) {
  ...
  var menuOptions = this.generateContextMenu(e);
  // RM Code End
 ...
 */
Blockly.BlockSvg.prototype.addHighlight = function() {
  this.pathObject.updateHighlighted(true);
};

/**
 * Unhighlight this block.  Remove its highlighting.
 */
Blockly.BlockSvg.prototype.removeHighlight = function() {
  this.pathObject.updateHighlighted(false);
};
// RM Code End
